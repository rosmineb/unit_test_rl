...
ray job submit --address="http://127.0.0.1:8265" \
          ...
          --init_kl_coef 0.0 \
          --apply_chat_template \
          --prompt_data /home/rosmine/data2/rl_codegen/datasets/pi_verifiable_no_fn_call_with_unit_tests_v2_train_with_reference_no_examples_few_shot_with_reference \
          --input_key prompt \
