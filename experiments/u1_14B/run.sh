...
ray job submit --address="http://127.0.0.1:8265" \
          ...
          --pretrain Qwen/Qwen2.5-Coder-14B-Instruct \
          --save_steps 10 \
          --logging_steps 1 \
          --eval_steps -1 \
          ...
          --init_kl_coef 0.0 \
          --prompt_data /home/rosmine/data2/rl_codegen/datasets/pi_verifiable_no_fn_call_train_with_unit_tests_v1 \
          --input_key prompt \
          ...
          --RM_CONFIG_response_begin_str "Please make sure the code is efficient." \
